...
struct AgentMessage: Identifiable, Hashable, Sendable, Codable {
    ...
    /// A tool call the model is still writing (its arguments are streaming).
...
/// A tool call being generated by the model, before it can run.
struct ToolCallDraft: Hashable, Sendable, Codable {
    let name: String
    /// Target path, once it can be read from the partial arguments.
    let path: String?
    /// Characters of arguments generated so far.
    let characters: Int
}
